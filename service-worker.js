// v0.2.5.4 signal autofill build: browser network info helper added.
const CACHE='rson-eact-one-act-v0.2.5.4';
const GUIDE_BUILD='v0.2.5.4-signal-autofill-2026-06-24';
