// v0.2.5.4 revision: removed route clear buttons after Hiron v2 check; cache refresh only, public version unchanged.
const CACHE='rson-eact-one-act-v0.2.5.4-rev-no-clear-route';
const GUIDE_BUILD='v0.2.5.4-no-clear-route-2026-06-24';
